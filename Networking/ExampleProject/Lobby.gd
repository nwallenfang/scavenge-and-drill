...
var Player = preload("res://Networking/ExampleProject/actors/Player.tscn")

export (PackedScene) var map_scene = preload("res://Networking/ExampleProject/maps/Map1.tscn")
